...
var BookDetail = require('./BookDetail.js');
var HorizontalScroller = require('./GridList.js');
var {
  Image,
  LayoutAnimation,
  ListView,
...
var Thumb = React.createClass({
  ...
  getChildContext: function () {
    return {
      sharedNavigator: this.props.navigator
    };
  },
  ...
  render: function() {
    return (
      ...
      <Text> ആദിയിൽ Hello! {this.props.text}</Text>
      </TouchableOpacity>
...
var ListViewPagingExample = React.createClass({
  ...
  renderRow: function(rowData: string, sectionID: string, rowID: string): ReactElement {
    return (<Thumb text={rowData} sharedNav={this.props.navigator}/>);
  },
